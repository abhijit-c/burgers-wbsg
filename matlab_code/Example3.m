...
u_wb = u4_wbsg(u0_h, b_h, E, T, dx);       % WB      eq 3.28
...
%% Non well balanced
u_non = u4_non(u0_h, b_h, E, T, dx);       % WB      eq 3.28
mean_non = u_non(1,2:end); 
sd_non = u_non.^2; sd_non = sd_non(2:end,2:end); sd_non=sqrt(sum(sd_non));
